...
const pixKey = 'mirellylash@pix.com.br';

pixBtn.addEventListener('click', () => {
    copyText(pixKey).then(() => {
        showToast('Chave PIX copiada! Mencione os 15% off no agendamento ✨');
    }).catch(() => {
...
if (wifiBtn && wifiModal) {
    ...
    if (wifiPhone) {
        wifiPhone.addEventListener('click', () => {
            window.open('https://api.whatsapp.com/send?phone=5554996779231', '_blank');
        });
    }
}
